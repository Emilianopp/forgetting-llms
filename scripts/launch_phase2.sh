#!/bin/bash
# Launch all Phase 2 experiments (SAFE starting point, Qwen2.5-3B)
# Usage: bash scripts/launch_phase2.sh
...
echo "=== Launching Phase 2: ${#METHODS[@]} methods × ${#DOMAINS[@]} domains ==="
